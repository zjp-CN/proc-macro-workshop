use syn::{
    punctuated::Punctuated, token::Comma, Attribute, Ident, LitStr, Meta, Result, WherePredicate,
};
...
mod search {
    ...
    use syn::{
        parse_quote, punctuated::Punctuated, Ident, Lit, Meta, MetaList, MetaNameValue, NestedMeta,
        Path, PredicateType, Type, TypePath, WherePredicate,
    };
