...
// Resources:
//
//   - The relevant types in the input will be represented in this syntax tree node: https://docs.rs/syn/1.0/syn/struct.TypePath.html
...
pub struct Field<T: Trait> {
    values1: Vec<T::Value>,
    values2: Vec<T::Value2>,
    values3: T::Value,
    values4: T::Value2,
    values5: std::collections::HashMap<T::Value, T::Value2>,
}
